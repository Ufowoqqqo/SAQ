...
Run `gist_sample100k`, `K=512`, `B=4`, top-100 only. This is the exact frozen
setting that produced the historical fac-error recall/QPS comparison; the
recorded numbers do not come from full GIST/K4096.
