# A4-V2 Governance History (Archived)

> Historical, non-active record. This file preserves the former root
> `AGENTS.md` governance and authorization chronology. It is not a source of
> current authorization and is not required reading unless a task explicitly
> concerns A4-V2 history. Current instructions are in the root `AGENTS.md`,
> `TASK.md`, and applicable directory-local `AGENTS.md` files.
