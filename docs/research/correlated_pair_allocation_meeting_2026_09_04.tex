...
\bibitem{opq} Ge et al. \emph{Optimized Product Quantization}. CVPR, 2013.
...
IEEE TCSVT, 2018.
\bibitem{quicker} Andre et al. \emph{Quicker ADC: Unlocking the Hidden
Potential of Product Quantization with SIMD}. IEEE TPAMI, 2021.
\bibitem{saq} Li et al. \emph{Scalable Accurate Quantization for Fast
Similarity Search}. SIGMOD, 2026.
\end{thebibliography}
\vfill
