...
| `R12` | 2026-07-13 draft Attempt 4 | Fixed-rate arbitrary-cardinality mixed-radix scalar-product quantization | `saq-arbitrary-cardinality-feasibility-v2@f13a383` | `ACTIVE` | preserve terminal A4-1S `NO_GO_EXACT_SOLVER_COST`; additive A4-V2-P-ERRATUM is `PROTOCOL_ERRATUM_INDEPENDENT_REVIEW_PASS`; prior source-only A4-V2-I is `AUTHORIZED_READY_TO_RESUME`, but no implementation pass, build, parity, synthetic run, data access, or SAQ change has occurred | `UNREPORTED` | `ABSENT` | `INCLUDED_PENDING_REPORT`, slides 59--65 |
...
| `R12` | A4-1S remains a terminal pipeline-cost stop: 61 scalar-coordinate shards used `34,805,155,525 us`, and its frozen `5/2` projection was `24.170246892361` CPU-hours. A4 V2 keeps the complete four-arm construction FOM `T_instrument=C_setup+C_core+C_bundle_io` and all separate build/parity/evidence/replay/archive/memory/byte ledgers. Source-only A4-V2-I inspection exposed a terminal-P receipt/publication self-reference before any implementation commit or review pass. The additive erratum closes only that protocol defect with a finite one-file `PAR_report`; the original parent blobs, scientific computation, FOM, threshold, parity/retry rules, and authorization boundary are unchanged. Its 5,171-byte seal witness is a conservative syntactic schema maximum, not a semantically admissible resource observation. The reviewed outcome is protocol correction only, not implementation, feasibility, natural-data, ANN, or systems evidence. | Old cost evidence `saq-arbitrary-cardinality-analysis@9ce1052`, reviewed terminal snapshot `@f1b464b`: `docs/saq_attempt4_a4_1s_artifacts_2026_07_13/synthetic_cost_projection_manifest.json`, `docs/saq_attempt4_a4_1s_artifacts_2026_07_13/synthetic_cost_projection_summary.json`, `docs/saq_attempt4_a4_1s_cost_projection_review_2026_07_13.md`. V2 primary review `saq-arbitrary-cardinality-feasibility-v2@c4ccea3`; parent protocol `@f86a51d`: `docs/saq_a4_v2_cost_evidence_primary_source_review_2026_07_14.md`, `docs/saq_a4_v2_cost_evidence_go_no_go_memo_2026_07_14.md`, `docs/saq_a4_v2_synthetic_construction_preregistration_2026_07_14.md`, `docs/saq_a4_v2_synthetic_construction_contract_2026_07_14.json`, `docs/saq_a4_v2_artifact_schema_2026_07_14.json`, `docs/saq_a4_v2_protocol_independent_review_2026_07_14.md`. Corrected erratum authority `@f13a383`, independent review at audited head `@98e6999`: `docs/saq_a4_v2_par_report_erratum_authorization_2026_07_14.md`, `docs/saq_a4_v2_par_report_timing_closure_erratum_2026_07_14.md`, `docs/saq_a4_v2_par_report_timing_closure_erratum_2026_07_14.json`, `docs/saq_a4_v2_par_report_seal_schema_2026_07_14.json`, `docs/saq_a4_v2_par_report_seal_maximal_instance_2026_07_14.json`, `docs/saq_a4_v2_protocol_authority_manifest_2026_07_14.json`, `docs/saq_a4_v2_par_report_timing_closure_erratum_independent_review_2026_07_14.md` | after this handoff, resume only the already authorized source/static-review stage `A4-V2-I`; no build, import, syntax/test command, parity, RNG, synthetic run, generated evidence, data read, or SAQ change; `A4-V2-PAR` and `A4-V2-SRUN` remain unauthorized |
...
| SAQ | `saq-arbitrary-cardinality-feasibility-v2` | `98e6999` | `FOLLOWUP` | `R12` | corrected additive PAR-report protocol authority at scientific snapshot `f13a383`, independently reviewed at branch head; source-only A4-V2-I is ready to resume, with no implementation pass, execution, or data access |
| SAQ | `saq-meeting-summary` | `SELF` -- commit containing this registry; parent at reconciliation `88795a7` | `SUMMARY` | all | summary-only; no experiment execution |
