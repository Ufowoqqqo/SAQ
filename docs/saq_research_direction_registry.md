...
| `R12` | 2026-07-13 draft Attempt 4 | Fixed-rate arbitrary-cardinality mixed-radix scalar-product quantization | `saq-arbitrary-cardinality-feasibility-v2@16a8201` | `AWAITING_AUTHORIZATION` | preserve terminal A4-1S `NO_GO_EXACT_SOLVER_COST` and reviewed A4-V2-PAR `ARTIFACT_INVALID / NO_SCIENTIFIC_DECISION`; CACHE-I remains `GENERIC_CACHE_POLICY_SOURCE_STATIC_REVIEW_PASS`; the exact PREP authorization target `e7f940e` and direct-child review `16a8201` reached only `PREP_AUTHORIZATION_EXACT_TARGET_REVIEW_PASS`; actual PREP, clone/token/receipt creation, CACHE-BIND, corrected PAR, and scientific execution remain unauthorized, and the unique review-head probe remains unspent for immediately before a separately authorized PREP | `UNREPORTED` | `ABSENT` | `INCLUDED_PENDING_REPORT`, slides 59--65 |
...
| `R12` | A4-1S remains a terminal pipeline-cost stop: 61 scalar-coordinate shards used `34,805,155,525 us`, and its frozen `5/2` projection was `24.170246892361` CPU-hours. The one authorized A4 V2 PAR invocation remains terminal at `ARTIFACT_INVALID` before any B/P worker, with no build/parity evidence or scientific decision. CACHE-P selected non-destructive sanitized remote isolation and rejected direct PAR-R1. The later exact CACHE-I source target `c33a2bf` and direct-child review `5db3025` closed 37 filesystem sources, ten Python plus 27 native sources, one separate inline bootstrap, four schema/maximal-instance pairs, and a 38-unit static import/process/mutation crosswalk at source-tree SHA-256 `9568007588c78ddda9fb4c4e20e8773ee2fa1da10a7656f181fef06883de38a2`; independent review found 0 issues at LOW or above. A separately authorized Python 3.9 `compile()`-only check accepted the exact six outer changed/new sources and inline bootstrap, but executed no code object and established no importability, runtime correctness, parity, cost, or scientific evidence. The exact three-path PREP authorization target `e7f940e` and direct-child review `16a8201` then reached `PREP_AUTHORIZATION_EXACT_TARGET_REVIEW_PASS` with 0 LOW+ findings. This is authorization-record governance only: actual PREP remains `NOT_AUTHORIZED`, no clone/token/receipt exists, and the unique review-head equality probe was deliberately not run and remains reserved for immediately before a separately user-authorized PREP with no intervening mutation. The maximum committed claim is not PREP readiness, feasibility, an SAQ limitation, systems performance, novelty, or a method. Quarantined residuals remain unread non-evidence. | Old cost evidence `saq-arbitrary-cardinality-analysis@9ce1052`, reviewed terminal snapshot `@f1b464b`: `docs/saq_attempt4_a4_1s_artifacts_2026_07_13/synthetic_cost_projection_manifest.json`, `docs/saq_attempt4_a4_1s_artifacts_2026_07_13/synthetic_cost_projection_summary.json`, `docs/saq_attempt4_a4_1s_cost_projection_review_2026_07_13.md`. V2 protocol `saq-arbitrary-cardinality-feasibility-v2@f86a51d`: `docs/saq_a4_v2_synthetic_construction_preregistration_2026_07_14.md`, `docs/saq_a4_v2_synthetic_construction_contract_2026_07_14.json`, `docs/saq_a4_v2_protocol_independent_review_2026_07_14.md`. PAR terminal target/review `@30dfada/@fd5367e`: `docs/saq_a4_v2_par_prebuild_artifact_identity_failure_2026_07_15.md`, `docs/saq_a4_v2_par_prebuild_artifact_identity_failure_independent_review_2026_07_15.md`. CACHE-P target/review `@56210f8/@249d5b8`: `docs/saq_a4_v2_cache_staging_disposition_protocol_2026_07_15.md`, `docs/saq_a4_v2_cache_staging_disposition_contract_2026_07_15.json`, `docs/saq_a4_v2_cache_staging_disposition_protocol_independent_review_2026_07_15.md`. CACHE-I authorization/review `@4f38ca9/@187e363`: `docs/saq_a4_v2_cache_implementation_authorization_2026_07_15.md`, `docs/saq_a4_v2_cache_implementation_authorization_independent_review_2026_07_15.md`. CACHE-I target/review `@c33a2bf/@5db3025`: `docs/saq_a4_v2_cache_protocol_authority_manifest_2026_07_15.json`, `docs/saq_a4_v2_cache_static_closure_2026_07_15.json`, `docs/saq_a4_v2_implementation_binding_2026_07_14.md`, `docs/saq_a4_v2_implementation_manifest_2026_07_14.json`, `docs/saq_a4_v2_source_provenance_crosswalk_2026_07_14.md`, `docs/saq_a4_v2_cache_implementation_independent_review_2026_07_15.md`. PREP authorization target/review `@e7f940e/@16a8201`: `docs/saq_a4_v2_isolated_clone_prep_authorization_2026_07_15.md`, `docs/saq_a4_v2_isolated_clone_prep_authorization_independent_review_2026_07_15.md`. | no execution is currently authorized; the next admissible node is a separately user-authorized single isolated PREP attempt, preceded immediately by the unique no-clone review-head equality probe with no intervening source-branch/worktree mutation; only a successful committed and independently reviewed receipt could lead, under further explicit authority, to CACHE-BIND and PAR-R1; PREP, CACHE-BIND, PAR-R1, SRUN, data access, quarantine access, and SAQ changes remain unauthorized |
...
| SAQ | `saq-arbitrary-cardinality-feasibility-v2` | `16a8201` | `FOLLOWUP` | `R12` | PREP authorization target `e7f940e` and direct-child review `16a8201` reached only `PREP_AUTHORIZATION_EXACT_TARGET_REVIEW_PASS`; actual PREP and the delayed review-head probe remain unexecuted, and CACHE-BIND, PAR-R1, SRUN, data, quarantine, and SAQ work remain unauthorized |
| SAQ | `saq-meeting-summary` | `SELF` -- commit containing this registry; parent at reconciliation `267969f` | `SUMMARY` | all | summary-only; no experiment execution |
