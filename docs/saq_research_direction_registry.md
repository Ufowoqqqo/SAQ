...
| `R12` | 2026-07-13 draft Attempt 4 | Fixed-rate arbitrary-cardinality mixed-radix scalar-product quantization | `saq-arbitrary-cardinality-feasibility-v2@482c401` | `AWAITING_AUTHORIZATION` | preserve terminal A4-1S `NO_GO_EXACT_SOLVER_COST`; A4-V2-I reached `SOURCE_IMPLEMENTED_STATIC_REVIEW_PASS` at corrected exact source commit `482c401`, while failed parent `3a4f7c5` remains non-evidence; no build, parity, synthetic run, data access, or SAQ change has occurred | `UNREPORTED` | `ABSENT` | `INCLUDED_PENDING_REPORT`, slides 59--65 |
...
| `R12` | A4-1S remains a terminal pipeline-cost stop: 61 scalar-coordinate shards used `34,805,155,525 us`, and its frozen `5/2` projection was `24.170246892361` CPU-hours. A4 V2 keeps the complete four-arm construction FOM `T_instrument=C_setup+C_core+C_bundle_io` and all separate build/parity/evidence/replay/archive/memory/byte ledgers. The additive erratum closed the terminal-P protocol self-reference without changing the scientific computation, FOM, threshold, parity/retry rules, or parent blobs. Corrected exact source commit `482c401` then passed three independent static-only reviews: its canonical manifest binds 35 exact source identities at source-tree SHA-256 `d5b8374ff2bfb967e0fbf758e2012029356ef779122681ed4a5a9d901e727cc7`. Failed parent `3a4f7c5` remains failed/non-evidence. The maximum claim is source and artifact-pipeline readiness only; no implementation was imported, built, syntax-checked, tested, or run, so there is still no PAR, feasibility, natural-data, ANN, or systems evidence. | Old cost evidence `saq-arbitrary-cardinality-analysis@9ce1052`, reviewed terminal snapshot `@f1b464b`: `docs/saq_attempt4_a4_1s_artifacts_2026_07_13/synthetic_cost_projection_manifest.json`, `docs/saq_attempt4_a4_1s_artifacts_2026_07_13/synthetic_cost_projection_summary.json`, `docs/saq_attempt4_a4_1s_cost_projection_review_2026_07_13.md`. V2 primary review `saq-arbitrary-cardinality-feasibility-v2@c4ccea3`; parent protocol `@f86a51d`: `docs/saq_a4_v2_cost_evidence_primary_source_review_2026_07_14.md`, `docs/saq_a4_v2_cost_evidence_go_no_go_memo_2026_07_14.md`, `docs/saq_a4_v2_synthetic_construction_preregistration_2026_07_14.md`, `docs/saq_a4_v2_synthetic_construction_contract_2026_07_14.json`, `docs/saq_a4_v2_artifact_schema_2026_07_14.json`, `docs/saq_a4_v2_protocol_independent_review_2026_07_14.md`. Corrected erratum authority `@f13a383`, independent review at `@98e6999`: `docs/saq_a4_v2_protocol_authority_manifest_2026_07_14.json`, `docs/saq_a4_v2_par_report_timing_closure_erratum_independent_review_2026_07_14.md`. Corrected source `@482c401`, independently reviewed at branch head `@4ce2e69`: `docs/saq_a4_v2_implementation_binding_2026_07_14.md`, `docs/saq_a4_v2_implementation_manifest_2026_07_14.json`, `docs/saq_a4_v2_source_provenance_crosswalk_2026_07_14.md`, `docs/saq_a4_v2_implementation_independent_review_2026_07_15.md` | await explicit authorization for `A4-V2-PAR`; no build, import, syntax/test command, parity, RNG, synthetic run, generated evidence, data read, or SAQ change is currently authorized; `A4-V2-SRUN` remains separately unauthorized |
...
| SAQ | `saq-arbitrary-cardinality-feasibility-v2` | `4ce2e69` | `FOLLOWUP` | `R12` | corrected source snapshot `482c401` reached `SOURCE_IMPLEMENTED_STATIC_REVIEW_PASS`, independently reviewed at branch head; failed parent `3a4f7c5` is non-evidence, and PAR/SRUN/data remain unauthorized |
| SAQ | `saq-meeting-summary` | `SELF` -- commit containing this registry; parent at reconciliation `7ee89fd` | `SUMMARY` | all | summary-only; no experiment execution |
