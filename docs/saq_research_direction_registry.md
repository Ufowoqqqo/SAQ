...
| `R12` | 2026-07-13 draft Attempt 4 | Fixed-rate arbitrary-cardinality mixed-radix scalar-product quantization | `saq-arbitrary-cardinality-feasibility-v2@eb1b893` | `AWAITING_AUTHORIZATION` | preserve terminal A4-1S `NO_GO_EXACT_SOLVER_COST` and reviewed A4-V2-PAR `ARTIFACT_INVALID / NO_SCIENTIFIC_DECISION`; CACHE-I remains `GENERIC_CACHE_POLICY_SOURCE_STATIC_REVIEW_PASS`; PREP authorization and both host-protocol governance stages remain documentation-only; after HOST-I-AUTH target/review `212a67b/@71e6bec`, the first HOST-I instruction stopped before a source target on the seven-versus-eight component contradiction, additive source-authority erratum target/review `6fe8544/@9fa9528` reached only `HOST_I_SOURCE_AUTHORITY_ERRATUM_REVIEW_PASS`, and the subsequent 14-path HOST-I target/review `4602585/@e8e9c79` remained failed evidence with one HIGH false governing-review identity; bounded correction-only repair protocol target/review `ddfef99/@b1a7429` reached `HOST_I_R1_CORRECTION_ONLY_REPAIR_PROTOCOL_REVIEW_PASS`; the separately authorized exact five-path R1 target/review `e17f887/@e10bde7` then reached `HOST_I_R1_CORRECTION_ONLY_REPAIR_REVIEW_PASS` with zero LOW-or-higher findings after independently reproducing the four equal-length artifact substitutions, unchanged source/authority closure, and 13/13 registered host objects; `HOST_IDENTITY_REBOUND = ESTABLISHED_FOR_REGISTERED_13_OBJECT_BUNDLE_ONLY`, while whole-host identity remains unestablished; bounded source-history protocol target/review `dcaed57/@e98a3e4` reached `SOURCE_HISTORY_EPOCH_CORRECTION_PROTOCOL_REVIEW_PASS` with zero LOW-or-higher findings after independently proving the exact five-blob legacy closure and strict four-legacy/six-active role partition; the first authorized `A4-V2-SOURCE-HISTORY-I` then stopped before target because exact projection proved its one-source/ten-path closure unsatisfiable: the runtime schema and maximal witness had no authorized semantic, output, or ledger delta; correction-only path-closure erratum target/review `150e5b3/@7749491` reached `SOURCE_HISTORY_I_R1_PATH_CLOSURE_ERRATUM_REVIEW_PASS` with zero LOW-or-higher findings after independently reproducing the necessary-and-sufficient eight-path/five-derived-object cascade; the subsequently authorized exact eight-path R1 target/review `e9b5c83/@a1198c4` reached `SOURCE_HISTORY_EPOCH_CORRECTION_SOURCE_STATIC_REVIEW_PASS` with zero LOW-or-higher findings: one verifier source changed by 38 net lines, the five legacy overrides and strict four-legacy/six-active role partition were reproduced, the original protocol contract remained the sole ninth component, and the canonical 37-source tree closed while the runtime schema and maximal witness remained byte-identical; this statically corrects the known source-history rule only; fresh dormant PREP authorization target/review `cd1757e/@eb1b893` then reached `PREP_AUTHORIZATION_EXACT_TARGET_REVIEW_PASS` with zero LOW-or-higher findings after independently closing the reviewed source head, current source/authority identities, registered-host ceiling, and corrected source history; this is documentation governance only: the ordinary target-head publication observation is not the reserved immediate review-head probe, no Python, build, verifier, PREP, data, or scientific execution occurred, and actual `A4-V2-CACHE-PREP-ISO-R1`, CACHE-BIND, corrected PAR, and scientific execution remain separate and unauthorized | `UNREPORTED` | `ABSENT` | `INCLUDED_PENDING_REPORT`, slides 59--65 |
...
| `R12` | A4-1S remains a terminal pipeline-cost stop at `24.170246892361` projected CPU-hours, and the one authorized A4 V2 PAR invocation remains terminal at `ARTIFACT_INVALID` before build/parity. CACHE-I reached only a generic source/static pass. HOST-I source-static target/review `4602585/@e8e9c79` remains immutable failed evidence; R1 target/review `e17f887/@e10bde7` repaired its false authority identity and established rebound only for the registered 13-object bundle. Source-history protocol target/review `dcaed57/@e98a3e4` passed, but the first authorized implementation stopped before target on its unsatisfiable ten-path closure. Path-closure erratum target/review `150e5b3/@7749491` froze the exact eight-path/five-derived-object repair. The subsequently authorized R1 target/review `e9b5c83/@a1198c4` reached `SOURCE_HISTORY_EPOCH_CORRECTION_SOURCE_STATIC_REVIEW_PASS` with zero LOW-or-higher findings after independently reproducing the exact five legacy overrides, strict four-legacy/six-active role partition, nine-component boundary, canonical 37-source tree `2007875777e7af28a67e89d574b33ec35e71436d8bfaa203574c4343ef4cf973`, and unchanged runtime schema/maximal witness. Fresh dormant PREP authorization target/review `cd1757e/@eb1b893` then reached `PREP_AUTHORIZATION_EXACT_TARGET_REVIEW_PASS` with zero LOW-or-higher findings after independent static identity/closure reproduction. This is documentation governance only: no reserved immediate review-head probe, Python, syntax/import, build, verifier, PREP, data, or scientific execution occurred, so whole-host identity, PREP readiness, and cache-verifier/PAR readiness remain unestablished. None of these governance results establishes feasibility, performance, an SAQ limitation, novelty, or a method. Quarantined residuals remain unread non-evidence. | Old cost evidence `saq-arbitrary-cardinality-analysis@9ce1052`, reviewed terminal snapshot `@f1b464b`: `docs/saq_attempt4_a4_1s_artifacts_2026_07_13/synthetic_cost_projection_manifest.json`, `docs/saq_attempt4_a4_1s_artifacts_2026_07_13/synthetic_cost_projection_summary.json`, `docs/saq_attempt4_a4_1s_cost_projection_review_2026_07_13.md`. V2 protocol `saq-arbitrary-cardinality-feasibility-v2@f86a51d`: `docs/saq_a4_v2_synthetic_construction_preregistration_2026_07_14.md`, `docs/saq_a4_v2_synthetic_construction_contract_2026_07_14.json`, `docs/saq_a4_v2_protocol_independent_review_2026_07_14.md`. PAR terminal target/review `@30dfada/@fd5367e`: `docs/saq_a4_v2_par_prebuild_artifact_identity_failure_2026_07_15.md`, `docs/saq_a4_v2_par_prebuild_artifact_identity_failure_independent_review_2026_07_15.md`. CACHE-I target/review `@c33a2bf/@5db3025`: `docs/saq_a4_v2_cache_protocol_authority_manifest_2026_07_15.json`, `docs/saq_a4_v2_cache_static_closure_2026_07_15.json`, `docs/saq_a4_v2_cache_implementation_independent_review_2026_07_15.md`. HOST-I source-static target/review `@4602585/@e8e9c79`: `docs/saq_a4_v2_prep_host_identity_rebind_implementation_independent_review_2026_07_16.md`. HOST-I-R1 protocol target/review `@ddfef99/@b1a7429`: `docs/saq_a4_v2_prep_host_identity_rebind_r1_correction_only_repair_protocol_2026_07_17.md`, `docs/saq_a4_v2_prep_host_identity_rebind_r1_correction_only_repair_contract_2026_07_17.json`, `docs/saq_a4_v2_prep_host_identity_rebind_r1_correction_only_repair_protocol_independent_review_2026_07_17.md`. HOST-I-R1 correction target/review `@e17f887/@e10bde7`: `docs/saq_a4_v2_implementation_binding_2026_07_14.md`, `docs/saq_a4_v2_implementation_manifest_2026_07_14.json`, `docs/saq_a4_v2_source_provenance_crosswalk_2026_07_14.md`, `docs/saq_a4_v2_prep_host_identity_rebind_r1_correction_only_repair_independent_review_2026_07_17.md`. Source-history protocol target/review `@dcaed57/@e98a3e4`: `docs/saq_a4_v2_source_history_epoch_correction_protocol_2026_07_17.md`, `docs/saq_a4_v2_source_history_epoch_correction_contract_2026_07_17.json`, `docs/saq_a4_v2_source_history_epoch_correction_protocol_independent_review_2026_07_17.md`. Source-history path-closure erratum target/review `@150e5b3/@7749491`: `docs/saq_a4_v2_source_history_i_r1_path_closure_erratum_protocol_2026_07_18.md`, `docs/saq_a4_v2_source_history_i_r1_path_closure_erratum_contract_2026_07_18.json`, `docs/saq_a4_v2_source_history_i_r1_path_closure_erratum_independent_review_2026_07_18.md`. Source-history R1 target/review `@e9b5c83/@a1198c4`: `script/a4_v2_cache_policy_verifier.py`, `docs/saq_a4_v2_cache_protocol_authority_manifest_2026_07_15.json`, `docs/saq_a4_v2_cache_static_closure_2026_07_15.json`, `docs/saq_a4_v2_implementation_binding_2026_07_14.md`, `docs/saq_a4_v2_implementation_manifest_2026_07_14.json`, `docs/saq_a4_v2_source_provenance_crosswalk_2026_07_14.md`, `docs/saq_a4_v2_source_history_epoch_correction_implementation_independent_review_2026_07_17.md`. Fresh R1 PREP authorization target/review `@cd1757e/@eb1b893`: `docs/saq_a4_v2_isolated_clone_prep_authorization_2026_07_15.md`, `docs/saq_a4_v2_isolated_clone_prep_authorization_independent_review_2026_07_15.md`. | no execution is currently authorized; fresh R1 PREP authorization/review is complete only at `PREP_AUTHORIZATION_EXACT_TARGET_REVIEW_PASS`; a separately explicit `A4-V2-CACHE-PREP-ISO-R1` grant and its immediate review-head probe, actual PREP, receipt review, CACHE-BIND, explicitly authorized PAR-R1, SRUN, data access, quarantine access, and SAQ changes all remain separate and unauthorized |
...
| SAQ | `saq-arbitrary-cardinality-feasibility-v2` | `eb1b893` | `FOLLOWUP` | `R12` | HOST-I source-static target/review `4602585/@e8e9c79` remains failed evidence; R1 target/review `e17f887/@e10bde7` established rebound only for the registered 13-object bundle; source-history protocol target/review `dcaed57/@e98a3e4` passed, but the first authorized implementation stopped before target on its unsatisfiable ten-path closure; path-closure erratum target/review `150e5b3/@7749491` froze the corrected boundary; exact R1 target/review `e9b5c83/@a1198c4` reached `SOURCE_HISTORY_EPOCH_CORRECTION_SOURCE_STATIC_REVIEW_PASS`; fresh dormant PREP authorization target/review `cd1757e/@eb1b893` then reached `PREP_AUTHORIZATION_EXACT_TARGET_REVIEW_PASS` with zero LOW-or-higher findings; this is documentation governance only, the reserved immediate probe was not run, actual PREP remains unauthorized, whole-host identity and cache-verifier/PAR readiness remain unestablished, and Python/build/verifier/PREP/data were not run |
| SAQ | `saq-meeting-summary` | `SELF` -- commit containing this registry; parent at reconciliation `5a36ab1` | `SUMMARY` | all | summary-only; no experiment execution |
