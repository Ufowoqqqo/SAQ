...
| `R12` | 2026-07-13 draft Attempt 4 | Fixed-rate arbitrary-cardinality mixed-radix scalar-product quantization | `saq-arbitrary-cardinality-feasibility-v2@9fa9528` | `AWAITING_AUTHORIZATION` | preserve terminal A4-1S `NO_GO_EXACT_SOLVER_COST` and reviewed A4-V2-PAR `ARTIFACT_INVALID / NO_SCIENTIFIC_DECISION`; CACHE-I remains `GENERIC_CACHE_POLICY_SOURCE_STATIC_REVIEW_PASS`; PREP authorization and both host-protocol governance stages remain documentation-only; after HOST-I-AUTH target/review `212a67b/@71e6bec`, the HOST-I instruction stopped before any source target because the frozen seven-component closure could not admit its required eighth component; additive source-authority erratum target/review `6fe8544/@9fa9528` reached only `HOST_I_SOURCE_AUTHORITY_ERRATUM_REVIEW_PASS`; HOST-I is `REAUTHORIZATION_REQUIRED_NOT_RUN`, host identity is not rebound, and Python/PREP remain `NOT_AUTHORIZED_NOT_RUN`; a separately disclosed future `SOURCE_HISTORY_MISMATCH` prevents cache-verifier/PAR-readiness claims until a separately authorized repair is implemented and independently reviewed; the old invocation authority is unspent but nontransferable, and the old probe is unspent but superseded and may never run or be reused; fresh PREP authorization, actual PREP, CACHE-BIND, corrected PAR, and scientific execution remain unauthorized | `UNREPORTED` | `ABSENT` | `INCLUDED_PENDING_REPORT`, slides 59--65 |
...
| `R12` | A4-1S remains a terminal pipeline-cost stop: 61 scalar-coordinate shards used `34,805,155,525 us`, and its frozen `5/2` projection was `24.170246892361` CPU-hours. The one authorized A4 V2 PAR invocation remains terminal at `ARTIFACT_INVALID` before any B/P worker, with no build/parity evidence or scientific decision. CACHE-P selected non-destructive sanitized remote isolation and rejected direct PAR-R1; CACHE-I target/review `c33a2bf/@5db3025` reached only a generic source/static pass. PREP authorization target/review `e7f940e/@16a8201` then reached only `PREP_AUTHORIZATION_EXACT_TARGET_REVIEW_PASS`. Before PREP, a root RPM update replaced the frozen `/usr/bin/python3.9` `.el9_8` object with `.el9_8.2`; PREP was not invoked and START was not created. Host-rebind erratum target/review `5a47fed/@b89dabe` reached only `HOST_IDENTITY_REBIND_PROTOCOL_REVIEW_PASS`, and HOST-I-AUTH target/review `212a67b/@71e6bec` reached only `AUTHORIZATION_EXACT_TARGET_REVIEW_PASS`. The subsequent HOST-I instruction stopped before any source target: its authorization simultaneously preserved the verifier's exact seven-component cache-authority set and required an eighth host-rebind erratum component. Additive source-authority erratum target/review `6fe8544/@9fa9528` passed three static review tracks with zero LOW+ findings and establishes only `HOST_I_SOURCE_AUTHORITY_ERRATUM_REVIEW_PASS`; it admits the eighth component and freezes exact future accounting but changes no implementation source or derived authority object. HOST-I is `REAUTHORIZATION_REQUIRED_NOT_RUN`, `HOST_IDENTITY_REBOUND` is `NOT_ESTABLISHED`, and Python/build/PREP/data are `NOT_AUTHORIZED_NOT_RUN`. Independent review also disclosed that a later cache-verifier/PAR path would deterministically reach `SOURCE_HISTORY_MISMATCH` after the planned source rebind because historical CACHE-I/PREP comparisons remain frozen; that separate problem is excluded from this erratum and forbids readiness claims until a separately authorized repair is implemented and independently reviewed. None of these governance results establishes PREP readiness, feasibility, performance, an SAQ limitation, novelty, or a method. The old invocation authority is unspent but nontransferable; the old probe is unspent but superseded and must never run or be reused. Quarantined residuals remain unread non-evidence. | Old cost evidence `saq-arbitrary-cardinality-analysis@9ce1052`, reviewed terminal snapshot `@f1b464b`: `docs/saq_attempt4_a4_1s_artifacts_2026_07_13/synthetic_cost_projection_manifest.json`, `docs/saq_attempt4_a4_1s_artifacts_2026_07_13/synthetic_cost_projection_summary.json`, `docs/saq_attempt4_a4_1s_cost_projection_review_2026_07_13.md`. V2 protocol `saq-arbitrary-cardinality-feasibility-v2@f86a51d`: `docs/saq_a4_v2_synthetic_construction_preregistration_2026_07_14.md`, `docs/saq_a4_v2_synthetic_construction_contract_2026_07_14.json`, `docs/saq_a4_v2_protocol_independent_review_2026_07_14.md`. PAR terminal target/review `@30dfada/@fd5367e`: `docs/saq_a4_v2_par_prebuild_artifact_identity_failure_2026_07_15.md`, `docs/saq_a4_v2_par_prebuild_artifact_identity_failure_independent_review_2026_07_15.md`. CACHE-P target/review `@56210f8/@249d5b8`: `docs/saq_a4_v2_cache_staging_disposition_protocol_2026_07_15.md`, `docs/saq_a4_v2_cache_staging_disposition_contract_2026_07_15.json`, `docs/saq_a4_v2_cache_staging_disposition_protocol_independent_review_2026_07_15.md`. CACHE-I target/review `@c33a2bf/@5db3025`: `docs/saq_a4_v2_cache_protocol_authority_manifest_2026_07_15.json`, `docs/saq_a4_v2_cache_static_closure_2026_07_15.json`, `docs/saq_a4_v2_cache_implementation_independent_review_2026_07_15.md`. PREP authorization target/review `@e7f940e/@16a8201`: `docs/saq_a4_v2_isolated_clone_prep_authorization_2026_07_15.md`, `docs/saq_a4_v2_isolated_clone_prep_authorization_independent_review_2026_07_15.md`. Host-rebind erratum target/review `@5a47fed/@b89dabe`: `docs/saq_a4_v2_prep_host_identity_rebind_erratum_protocol_2026_07_16.md`, `docs/saq_a4_v2_prep_host_identity_rebind_erratum_contract_2026_07_16.json`, `docs/saq_a4_v2_prep_host_identity_rebind_erratum_independent_review_2026_07_16.md`. HOST-I-AUTH target/review `@212a67b/@71e6bec`: `docs/saq_a4_v2_prep_host_identity_rebind_implementation_authorization_2026_07_16.md`, `docs/saq_a4_v2_prep_host_identity_rebind_implementation_authorization_independent_review_2026_07_16.md`. Source-authority erratum target/review `@6fe8544/@9fa9528`: `docs/saq_a4_v2_prep_host_identity_rebind_implementation_erratum_protocol_2026_07_16.md`, `docs/saq_a4_v2_prep_host_identity_rebind_implementation_erratum_contract_2026_07_16.json`, `docs/saq_a4_v2_prep_host_identity_rebind_implementation_erratum_independent_review_2026_07_16.md`. | no execution is currently authorized; the next admissible node is fresh explicit authorization for `A4-V2-PREP-HOST-I` source-static rebind and its direct-child review; before cache-verifier/PAR readiness can be claimed, the disclosed historical-source comparison also requires a separate protocol/source repair that is implemented and independently reviewed; fresh PREP authorization/review, a new invocation grant and immediate probe, actual PREP, receipt review, CACHE-BIND, explicitly authorized PAR-R1, SRUN, data access, quarantine access, and SAQ changes remain unauthorized |
...
| SAQ | `saq-arbitrary-cardinality-feasibility-v2` | `9fa9528` | `FOLLOWUP` | `R12` | HOST-I stopped before any source target on an unsatisfiable 7-versus-8 component closure; additive source-authority erratum target/review `6fe8544/@9fa9528` reached only `HOST_I_SOURCE_AUTHORITY_ERRATUM_REVIEW_PASS`; HOST-I requires fresh authorization, host identity is not rebound, and Python/PREP were not run; a separately disclosed future `SOURCE_HISTORY_MISMATCH` forbids cache-verifier/PAR-readiness claims until a separately authorized repair is implemented and independently reviewed |
| SAQ | `saq-meeting-summary` | `SELF` -- commit containing this registry; parent at reconciliation `a211f41` | `SUMMARY` | all | summary-only; no experiment execution |
