...
| `R12` | 2026-07-13 draft Attempt 4 | Fixed-rate arbitrary-cardinality mixed-radix scalar-product quantization | `saq-arbitrary-cardinality-feasibility-v2@56210f8` | `AWAITING_AUTHORIZATION` | preserve terminal A4-1S `NO_GO_EXACT_SOLVER_COST` and reviewed A4-V2-PAR `ARTIFACT_INVALID / NO_SCIENTIFIC_DECISION`; the A4-V2-CACHE-P exact target reached `EXACT_TARGET_INDEPENDENT_REVIEW_PASS` and records `GO_SANITIZED_REMOTE_ISOLATION_PROTOCOL_REQUIRED / NO_GO_DIRECT_PAR_R1`; no CACHE-I implementation, clone preparation, receipt/review, CACHE-BIND, corrected PAR, or scientific execution is authorized | `UNREPORTED` | `ABSENT` | `INCLUDED_PENDING_REPORT`, slides 59--65 |
...
| `R12` | A4-1S remains a terminal pipeline-cost stop: 61 scalar-coordinate shards used `34,805,155,525 us`, and its frozen `5/2` projection was `24.170246892361` CPU-hours. A4 V2 keeps the complete four-arm construction FOM `T_instrument=C_setup+C_core+C_bundle_io` and all separate build/parity/evidence/replay/archive/memory/byte ledgers. The one authorized PAR invocation remains terminal at `ARTIFACT_INVALID`: it stopped before any B/P worker because the no-follow reader rejected the `/bin/python` symlink, produced no build/parity evidence, and established no valid PAR authority or scientific decision. A4-V2-I-R1 exact source `e48df452` repairs only that CPython identity path and passed static review. CACHE-P exact target `56210f8` then reviewed CPython cache behavior and frozen local source without reading quarantined payloads. It selects non-destructive sanitized remote isolation, rejects direct PAR-R1, and freezes a future authority DAG; exact-target review found 0 issues at LOW or above. The committed claim is `EXACT_TARGET_INDEPENDENT_REVIEW_PASS`, an artifact-governance protocol target only, not source implementation, clone readiness, parity, feasibility, SAQ evidence, or a method. The 35-source tree remains `8d8b5d3f8990e5d360e0a617d157a8b934c14d0f37b69f399bcc62c71f98360a`; quarantined staging/cache residuals remain unread non-evidence. | Old cost evidence `saq-arbitrary-cardinality-analysis@9ce1052`, reviewed terminal snapshot `@f1b464b`: `docs/saq_attempt4_a4_1s_artifacts_2026_07_13/synthetic_cost_projection_manifest.json`, `docs/saq_attempt4_a4_1s_artifacts_2026_07_13/synthetic_cost_projection_summary.json`, `docs/saq_attempt4_a4_1s_cost_projection_review_2026_07_13.md`. V2 primary review `saq-arbitrary-cardinality-feasibility-v2@c4ccea3` and protocol `@f86a51d`: `docs/saq_a4_v2_cost_evidence_primary_source_review_2026_07_14.md`, `docs/saq_a4_v2_cost_evidence_go_no_go_memo_2026_07_14.md`, `docs/saq_a4_v2_synthetic_construction_preregistration_2026_07_14.md`, `docs/saq_a4_v2_synthetic_construction_contract_2026_07_14.json`, `docs/saq_a4_v2_artifact_schema_2026_07_14.json`, `docs/saq_a4_v2_protocol_independent_review_2026_07_14.md`. Corrected erratum authority `@f13a383`, independently reviewed at `@98e6999`: `docs/saq_a4_v2_protocol_authority_manifest_2026_07_14.json`, `docs/saq_a4_v2_par_report_timing_closure_erratum_independent_review_2026_07_14.md`. Corrected source `@482c401`, independently reviewed at `@4ce2e69`: `docs/saq_a4_v2_implementation_independent_review_2026_07_15.md`. PAR terminal sequence authorization `@2e983a0`, result `@30dfada`, review `@fd5367e`: `docs/saq_a4_v2_par_authorization_2026_07_15.md`, `docs/saq_a4_v2_par_prebuild_artifact_identity_failure_2026_07_15.md`, `docs/saq_a4_v2_par_prebuild_artifact_identity_failure_independent_review_2026_07_15.md`. I-R1 authorization `@fe10bc3`, exact repaired source `@e48df452`, review head `@c401dae`: `docs/saq_a4_v2_executable_identity_source_repair_authorization_2026_07_15.md`, `docs/saq_a4_v2_implementation_binding_2026_07_14.md`, `docs/saq_a4_v2_implementation_manifest_2026_07_14.json`, `docs/saq_a4_v2_source_provenance_crosswalk_2026_07_14.md`, `docs/saq_a4_v2_executable_identity_source_repair_independent_review_2026_07_15.md`. CACHE-P authorization `@ffd0f41`: `docs/saq_a4_v2_cache_staging_policy_authorization_2026_07_15.md`. CACHE-P exact target `@56210f8`, direct-child review record `@249d5b8`: `docs/saq_a4_v2_cache_staging_primary_sources_2026_07_15.json`, `docs/saq_a4_v2_cache_staging_primary_source_review_2026_07_15.md`, `docs/saq_a4_v2_cache_staging_disposition_protocol_2026_07_15.md`, `docs/saq_a4_v2_cache_staging_disposition_contract_2026_07_15.json`, `docs/saq_a4_v2_cache_staging_disposition_protocol_independent_review_2026_07_15.md`. | direct PAR-R1 is no-go; the next admissible node is separately authorized `A4-V2-CACHE-I` generic source/schema/static review, followed only under separate authorities by PREP authorization/review, one sanitized preparation attempt, receipt/review, CACHE-BIND, and separately explicit PAR-R1; CACHE-I, PREP, receipt/review, CACHE-BIND, PAR-R1, SRUN, data access, and SAQ changes are all currently unauthorized |
...
| SAQ | `saq-caq-optimality-analysis` | `54e1328` | `PRIMARY` | `R09` | v1 official-source contract stopped; later workflow-guidance-only commit does not advance the scientific snapshot |
...
| SAQ | `saq-arbitrary-cardinality-feasibility-v2` | `249d5b8` | `FOLLOWUP` | `R12` | CACHE-P exact target `56210f8` passed independent review and freezes `GO_SANITIZED_REMOTE_ISOLATION_PROTOCOL_REQUIRED / NO_GO_DIRECT_PAR_R1`; this is governance only, and CACHE-I, PREP, receipt/review, CACHE-BIND, PAR-R1, SRUN, data, and SAQ work remain unauthorized |
| SAQ | `saq-meeting-summary` | `SELF` -- commit containing this registry; parent at reconciliation `1764129` | `SUMMARY` | all | summary-only; no experiment execution |
