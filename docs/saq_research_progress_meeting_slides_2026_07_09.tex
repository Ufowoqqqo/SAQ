...
\begin{itemize}
  ...
  \item Graph-traversal direction: SAQ staged estimates show local rank recovery against a formula-level SymphonyQG-style vertex proxy, but the baseline still needs fuller alignment.
\end{itemize}
\end{frame}
...
% ----------------------------------------------------------------------
\begin{frame}[fragile]{Graph Replay: First GIST Result}
\scriptsize
...
\toprule
estimator & bits/cand & top1 disag. & mean rank & p90 rank & top8 contain. \\
\midrule
...
% ----------------------------------------------------------------------
\begin{frame}[fragile]{Current Stronger Local Baseline}
\small
...
% ----------------------------------------------------------------------
\begin{frame}[fragile]{Stronger Baseline Result}
\scriptsize
GIST sample50k / K512 / B=4 / subset 4096.

\begin{tabular}{lrrrrrr}
\toprule
estimator & bits/cand & top1 disag. & mean rank & p90 rank & top4 & top8 \\
\midrule
