...
|---|---:|---:|---:|---:|
| a1024_p2_grid_endpoints_cached_features | 10 | 10/10 | 10/10 | 147.082 |

## Cost-Reduction Summary

- Total measured scorer runtime: 147.082 s.
- Reference scorer runtime from the overhead table: 481.764 s.
- Runtime ratio vs reference: 0.305.
- Feature-cache statuses: 5 hits, 3 cold misses.
- Measured residual-risk time in this run: 111.166 s.
- Measured tail-risk time in this run: 28.985 s.
- Measured boundary-pair sampling time in this run: 1.251 s.
- Measured scoring-grid time in this run: 0.058 s.
...
|---|---|---|---|---|---:|---:|---:|---:|---:|---|---:|---:|---:|---:|
| gist_full_K4096_B3 | a1024_p2_grid_endpoints_cached_features | promote | promote | `64:8,320:5,320:2,256:0` | True | 2048 | 0.139 | 64 | 0.005 | miss_written | 1.002 | 0.006 | 134.929 | 0.930 |
| gist_full_K4096_B4 | a1024_p2_grid_endpoints_cached_features | promote | promote | `128:9,320:5,320:3,192:0` | True | 2048 | 0.139 | 160 | 0.005 | hit |  | 0.012 | 1.593 | 0.011 |
| gist_full_K4096_B5 | a1024_p2_grid_endpoints_cached_features | promote | promote | `128:9,128:7,320:5,320:3,64:0` | True | 2048 | 0.139 | 160 | 0.005 | hit |  | 0.011 | 1.621 | 0.011 |
| cifar60k_B3 | a1024_p2_grid_endpoints_cached_features | promote | promote | `128:6,64:4,192:2,128:0` | True | 534 | 0.500 | 128 | 0.005 | miss_written | 0.099 | 0.008 | 4.549 | 0.539 |
| cifar60k_B4 | a1024_p2_grid_endpoints_cached_features | promote | promote | `128:7,256:4,128:0` | True | 534 | 0.500 | 128 | 0.005 | hit |  | 0.008 | 0.192 | 0.023 |
| cifar60k_B5 | a1024_p2_grid_endpoints_cached_features | promote | promote | `128:8,64:6,256:4,64:0` | True | 534 | 0.500 | 128 | 0.005 | hit |  | 0.007 | 0.189 | 0.022 |
| deep1M_sample100k_B4 | a1024_p2_grid_endpoints_cached_features | reject | reject | `128:4,128:3` | True | 952 | 0.500 | 64 | 0.005 | miss_written | 0.150 | 0.003 | 3.838 | 0.672 |
| deep1M_sample100k_B5 | a1024_p2_grid_endpoints_cached_features | reject | reject | `128:5,128:4` | True | 952 | 0.500 | 64 | 0.005 | hit |  | 0.003 | 0.170 | 0.030 |
